...
<section role="main" class="content-body card-margin">
    <header class="page-header">
        <h2>ONLINE PC BUILDER | Admin Panel | Hard Disk Drive</h2>
    </header>
        ...
        <div class="col">
            <section class="card">
                ...
                <?php if($this->session->userdata('p_id')){ ?>
                    <form class="form-horizontal form-bordered" action="<?php echo $baseurl; ?>welcome/hdd_insert" method="post" enctype='multipart/form-data'>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="name" class="form-control" placeholder="Product Name" value='<?php echo $hdd[0]->name; ?>'>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="storage" class="form-control" placeholder="Storage" value='<?php echo $hdd[0]->storage; ?>'>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="brand" class="form-control" placeholder="Brand" value='<?php echo $hdd[0]->brand; ?>'>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="price" class="form-control" placeholder="Price" value='<?php echo $hdd[0]->price; ?>'>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="quantity" class="form-control" placeholder="Quantity" value='<?php echo $hdd[0]->quantity; ?>'>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-6">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="performance" class="form-control"
                                        placeholder="Performance" value='<?php echo $hdd[0]->performance; ?>'>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
