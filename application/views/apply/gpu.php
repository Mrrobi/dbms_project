...
<section role="main" class="content-body card-margin">
    <header class="page-header">
        <h2>ONLINE PC BUILDER | Admin Panel | Graphics Card</h2>
    </header>
        ...
        <div class="col">
            <section class="card">
                ...
                <?php if($this->session->userdata('p_id')){ ?>
                    <form class="form-horizontal form-bordered" action="<?php echo $baseurl; ?>welcome/gpu_insert" method="post" enctype='multipart/form-data'>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="name" class="form-control" placeholder="Product Name" value='<?php echo $gpu[0]->name; ?>'>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 control-label text-lg-right pt-2">DDR</label>
                            <div class="col-lg-6">
                                <div class="input-group">
                                    <span class="input-group-prepend">
                                        <span class="input-group-text">
                                    ...
                                    <input type="text" name="ddr" class="form-control" placeholder="DDR" value='<?php echo $gpu[0]->ddr; ?>'>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="pci_slot" class="form-control" placeholder="PCI SLOT" value='<?php echo $gpu[0]->pci_slot; ?>'>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="brand" class="form-control" placeholder="Brand" value='<?php echo $gpu[0]->brand; ?>'>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="price" class="form-control" placeholder="Price" value='<?php echo $gpu[0]->price; ?>'>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="quantity" class="form-control" placeholder="Quantity" value='<?php echo $gpu[0]->quantity; ?>'>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-6">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="performance" class="form-control"
                                        placeholder="Performance" value='<?php echo $gpu[0]->performance; ?>'>
                                </div>
                            </div>
                        </div>
                       ...
                       <div class="form-group row">
                           ...
                           <div class="col-lg-6">
                               <div class="input-group">
                                   ...
                                   <input type="text" name="ddr" class="form-control" placeholder="DDR">
                               </div>
                           </div>
                       </div>
                       <div class="form-group row">
