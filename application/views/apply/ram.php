...
<section role="main" class="content-body card-margin">
    <header class="page-header">
        <h2>ONLINE PC BUILDER | Admin Panel | RAM</h2>
    </header>
    <?php 
        $ram = '';
        ...
        <div class="col">
            <section class="card">
                ...
                <?php if($this->session->userdata('p_id')){ ?>
                    <form class="form-horizontal form-bordered" action="<?php echo $baseurl; ?>welcome/ram_insert" method="post" enctype='multipart/form-data'>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="name" class="form-control" placeholder="Product Name" value='<? echo $ram[0]->name; ?>'>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="bus" class="form-control" placeholder="bus" value='<? echo $ram[0]->bus; ?>'>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="storage" class="form-control" placeholder="Storage" value='<? echo $ram[0]->storage; ?>'>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="brand" class="form-control" placeholder="Brand" value='<? echo $ram[0]->brand; ?>'>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="price" class="form-control" placeholder="Price" value='<? echo $ram[0]->price; ?>'>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="quantity" class="form-control" placeholder="Quantity" value='<? echo $ram[0]->quantity; ?>'>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-6">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="performance" class="form-control"
                                        placeholder="Performance" value='<? echo $ram[0]->performance; ?>'>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                    ...
                    <form class="form-horizontal form-bordered" action="<?php echo $baseurl; ?>welcome/ram_insert" method="post" enctype='multipart/form-data'>
                        ...
                        <!-- <div class="form-group row">
                            <label class="col-lg-3 control-label text-lg-right pt-2">Product Genaration</label>
                            <div class="col-lg-6">
                                <div class="input-group">
                                    <span class="input-group-prepend">
                                        <span class="input-group-text">
